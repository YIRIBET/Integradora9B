        ...
        <div className="flex flex-1 overflow-hidden flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-6 overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-lg font-semibold">Invitados Registrados</h4>
            ...
            {guests.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="mt-2 text-gray-500">No hay invitados registrados</p>
                <p className="text-sm text-gray-400">Agrega invitados usando el formulario</p>
              </div>
            ) : (
              <div className="space-y-3">
                {guests.map((guest, index) => (
                  <div key={index} className="border rounded-lg p-3 hover:bg-gray-50 transition-colors relative">
                    <button 
                    ...
                    <div className="font-medium">{guest.name} {guest.lastname} {guest.surname}</div>
        ...
        <div className="flex justify-end p-4 border-t">
          <div className="space-x-3">
            <button
              ...
              onClick={saveGuests}
              disabled={isSavingGuests || guests.length === 0}
            >
              {isSavingGuests ? (
