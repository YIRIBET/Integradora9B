...
function Traking() {
  ...
  try {
    const result = await Swal.fire({
      ...
      text: 'Se enviará un correo electrónico a este invitado',
      icon: 'question',
      showCancelButton: true,
        ...
        {filteredGuests.length > 0 ? (
          filteredGuests.map((guest) => (
            ...
            >
              ...
              <div className="flex items-center ml-auto">
                <button
          onClick={() => sendEmailInvitation(guest.id_guest)} // Aquí usamos el ID del invitado
          title="Enviar invitación por email"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            />
                ...
                <button
                onClick={() => sendWhatsAppInvitation(guest.phone)}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
